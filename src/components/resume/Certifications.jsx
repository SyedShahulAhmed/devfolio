        ...
        <div className="grid md:grid-cols-2 gap-5">
          {certifications.map((cert, idx) => (
            ...
            >
              ...
              {/* Status label */}
              <p className="mb-2 text-[10px] uppercase tracking-widest text-cyan-400/80">
                Verified Credential
              </p>
              ...
              {/* Inner glow */}
              <div className="pointer-events-none absolute inset-0 shadow-[inset_0_0_26px_rgba(0,191,255,0.1)]" />
            </motion.button>
          ))}
        </div>
      </Section>
