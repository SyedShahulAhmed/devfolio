...
const TimefallDrop = ({ x, delay, duration, opacity, drift }) => (
  ...
  >
    <div
      className="bg-linear-to-b from-transparent via-cyan-400/60 to-transparent"
      style={{
        width: "1px",
...
const Background = () => {
  return (
    <div className="fixed inset-0 z-20 pointer-events-none">
      ...
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_160%_90%_at_-35%_-10%,rgba(0,0,0,0.95)_0%,rgba(0,0,0,0.9)_28%,rgba(0,191,255,0.22)_46%,transparent_72%),radial-gradient(ellipse_180%_80%_at_120%_-15%,rgba(0,191,255,0.18)_0%,rgba(0,191,255,0.08)_32%,transparent_65%),linear-gradient(to_bottom,rgba(0,0,0,0.55),transparent_45%)]" />
