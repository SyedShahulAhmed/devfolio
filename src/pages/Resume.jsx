    ...
    <>
      ...
      <main className="relative z-10 min-h-screen bg-[#02040B] px-6 py-20">
        <div className="relative font-body max-w-6xl mx-auto space-y-20 text-slate-200">
          ...
          {/* Quote */}
          <section className="border-l-4 border-cyan-400 pl-6 max-w-3xl">
            <p className="italic text-cyan-300 text-sm">“{quote.text}”</p>
            <p className="mt-2 text-[11px] tracking-[0.25em] uppercase text-slate-500">
              — {quote.author}
            </p>
          </section>
          ...
          >
            <div className="relative border border-cyan-400/30 bg-black/60 p-7 text-sm text-slate-300 leading-relaxed overflow-hidden">
              {/* HUD corners */}
              ...
              {/* TEXT */}
              <p className="indent-10 tracking-[0.04em] capitalize text-slate-300">
                {summary}
              </p>
            </div>
          </Section>
